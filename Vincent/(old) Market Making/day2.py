    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            if product == "AMETHYSTS" or product == "STARFRUIT":
                ...
                print(f"Humidity: {state.observations.conversionObservations[product].humidity}")
                print(f"Sunlight: {state.observations.conversionObservations[product].sunlight}")
                print(f"exportTariffs: {state.observations.conversionObservations[product].exportTariff}")
                print(f"importTariffs: {state.observations.conversionObservations[product].importTariff}")
                print(f"TransportationFees: {state.observations.conversionObservations[product].transportFees}")
